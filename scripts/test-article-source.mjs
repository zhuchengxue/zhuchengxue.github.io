...
import { transformDropboxArticle } from './lib/article-transform.mjs';
...
try {
  mkdirSync(resolve(vault, '已发布'), { recursive: true });
  ...
  const transformed = await transformDropboxArticle(fresh, { vaultPath: vault, projectRoot: project });
